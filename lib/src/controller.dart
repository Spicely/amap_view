...
class AMapController {
  ...
  static Future<AMapController> init(int id, _AmapViewState state) async {
    assert(id != null);
    final MethodChannel channel = MethodChannel('plugins.muka.com/amap_view_$id');
  ...
  Future<dynamic> _handleMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'poi#onTap':
        ...
        break;
      case 'camera#onMove':
        if (_mapState.widget.onCameraMove != null) _mapState.widget.onCameraMove(CameraPosition.fromMap(call.arguments['position']));
        break;
      case 'camera#onIdle':
        if (_mapState.widget.onCameraIdle != null) _mapState.widget.onCameraIdle(CameraPosition.fromMap(call.arguments['position']));
        break;
      default:
